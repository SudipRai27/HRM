...
<?php
	...
	$start_date = $controller->changeDateFormatfromHyphenToSlash($leave_request->start_date);
	$end_date = $controller->changeDateFormatfromHyphenToSlash($leave_request->end_date);
	$user_type = $controller->checkUserType();

?>
<div class="row">
	<div class="col-xs-12">
	<h4><b>Edit Leave Request</b></h4>
		...
		<div class="box"> 
			<div class="box-body">							
                ...
                <button type = "button" class = "close" data-dismiss = "alert">X</button>
          		...
          		@endif
				<form action="{{route('edit-leave-post', $leave_request->id)}}" method="POST" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<option value="{{$index}}" @if($leave_request->user_id == $index) selected @endif>{{$value}}</option>
							@endforeach
							</select>
						...
						<div class="form-group">
							<b>Reason / Description:</b> <textarea type="text" name="description" class="form-control" placeholder="Enter Reason or Description" rows="6">{{$leave_request->description}}</textarea>
